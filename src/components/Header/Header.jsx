        ...
        <>
            <div className='flex justify-between items-center mb-7'>
                ...
                <div className='flex justify-center items-center gap-2 md:gap-9'>
                    <ul className='flex justify-center items-center gap-2 md:gap-9 text-[10px] md:text-[16px] text-gray-600'>
                        <li><a href="">Home</a></li>
            ...
            <div className='w-full h-[545px] rounded-lg bg-gradient-to-tr from-[#636b86] to-[#c299a2] text-center flex flex-col items-center justify-center space-y-4'>
                ...
                <h2 className='text-2xl md:text-4xl font-semibold text-white'>Assemble Your Ultimate Dream 11 Cricket Team </h2>
                <p className='text-gray-300 md:text-xl'>Beyond Boundaries Beyond Limits</p>
